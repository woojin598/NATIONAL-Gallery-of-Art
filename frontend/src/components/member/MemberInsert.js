...
function MemberInsert() {
  ...
  function onSubmitHandler(e) {
    ...
    fetchFn(
      "POST",
      `http://localhost:8000/member-service/all/members`,
      dto
    ).then((data) => {
      if (data === undefined) {
        console.log(data);
          ...
          <div className={styles.signupContainer}>
            ...
            >
              ...
              <div className={styles.formGroup}>
                <label className={styles.FormCheck_Label}>
                  ...
                  <span className={styles.checkboxLabel}>
                    NATIONAL Gallery of Art의{" "}
                    <a href="/NATIONALGalleryofArt/Terms">서비스 약관</a>,{" "}
                    <a href="/NATIONALGalleryofArt/privacy">
                      개인 정보 보호 정책
                    </a>
                    에 동의합니다.
                  </span>
              ...
              <form className={styles.formGroupLogin}>
                <div>
                  이미 계정이 있으신가요?{" "}
                  <Link to="/member-service/login" className={styles.loginLink}>
                    로그인
                  </Link>
                </div>
              </form>
