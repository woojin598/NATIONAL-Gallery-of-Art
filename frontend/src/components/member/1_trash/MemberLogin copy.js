        ...
        <Col>
          ...
          <div className={styles["login-container"]}>
            <div className={styles["login-form"]}>
              <div className={styles["login_wrap"]}>
                <div className={styles["login_content"]}>
                  ...
                  {/* 로그인 폼 */}
                  <Form id="loginForm" onSubmit={onSubmitHandler} className={styles.login_form}>
                    <FormGroup>
                      <FormControl
                        type="text"
                        id="loginID"
              ...
              <div className={styles["signup-form"]}>
                {/* 아이디 찾기, 비밀번호 찾기, 회원가입 탭 */}
                <ul className="list-unstyled mt-3">
                  <li>
                    <Link to=" ">
                      <span className="bold">아이디 찾기(예정)</span>
                    </Link>
                    <span>&nbsp;│&nbsp;</span>
                    <Link to=" ">
                      <span className="bold">비밀번호 찾기(예정)</span>
                    </Link>
                    <span>&nbsp;│&nbsp;</span>
                    <Link to="/member-service/insert">
            ...
            <div className={styles.login_wrap2}>
              소셜 로그인 버튼 위치입니다.(구현예정)
              <li className="list-unstyled">
                <Link to="">
                  <button className={styles["btn-login-social_wrap"]}>
                  <p>네이버로그인 구현예정</p>
                    {/* <img
                      src="/images/btn_naver_signin.png"
                      alt="네이버 로고"
